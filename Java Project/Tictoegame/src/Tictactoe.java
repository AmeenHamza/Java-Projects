...
public class Tictactoe {
	...
	private void WinningGame() {
		...
		// For player o
			...
			JOptionPane.showMessageDialog(frame, "Match Draw ...","Tic Tac Toe Game",JOptionPane.INFORMATION_MESSAGE);
	...
	private void initialize() {
		...
		xCount.setForeground(new Color(0, 255, 0));
		...
		oCount.setForeground(new Color(0, 255, 0));
		...
		panel_8.add(btn7, BorderLayout.CENTER);
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(JOptionPane.showConfirmDialog(frame, "Confirm You Want To Exit","Tic Tac Toe Game",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_NO_OPTION) {
					System.exit(0);
				}
